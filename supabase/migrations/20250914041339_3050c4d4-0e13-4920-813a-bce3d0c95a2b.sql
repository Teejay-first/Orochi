-- Security Fixes Migration - Tables Only
-- Fix anonymous access warnings for actual tables

-- 1. FIX ANONYMOUS ACCESS - AGENT ACCESS TABLES
...
-- 2. FIX AGENTS TABLE ANONYMOUS ACCESS
...
-- 3. FIX CONVERSATION TURNS ANONYMOUS ACCESS
...
-- 4. FIX PROFILES ANONYMOUS ACCESS
